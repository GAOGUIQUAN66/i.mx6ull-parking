...
void HardwareInit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HardwareInit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->initFinished((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HardwareInit::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HardwareInit::initFinished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HardwareInit::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_HardwareInit.data,
    qt_meta_data_HardwareInit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HardwareInit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HardwareInit.stringdata0))
...
// SIGNAL 0
void HardwareInit::initFinished(bool _t1)
{
